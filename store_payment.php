...
$url = "store_receipt.php?name=" . urlencode($name) . "&email=" . urlencode($email) . "&mobile=" . urlencode($mobile) . "&product_name=" . urlencode($product_name)."&product_price=" . urlencode($product_price);
?>
...
<body>
    <div class="cc">
        ...
        <form class="cc__form"  action="<?php echo $url; ?>" method="POST">
            <fieldset>
                ...
                <input class="button" type="submit" value="Buy Now" tabindex="5"  />
            </fieldset>
        </form>
